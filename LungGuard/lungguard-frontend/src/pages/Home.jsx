...
function Home() {
  ...
  return (
    <div className="relative overflow-hidden min-h-[calc(100vh-8rem)] flex flex-col justify-center py-10">
      {/* Visual background accents */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-sky-500/5 rounded-full blur-[160px] pointer-events-none -z-10" />
      ...
      >
        ...
        <motion.div 
          variants={itemVariants}
          className="mt-20 flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-xs font-semibold text-slate-500"
        >
